...
public class BlockLittleBoy extends BlockNuke {
	public BlockLittleBoy(int blockID) {
		super(blockID);
	}
	...
	public Callback detonate(World world, int x, int y, int z) {
		if (!world.multiplayerWorld) {
			...
			world.entityJoinedWorld(new EntityExplosionHelper(world, x+0.5, y+0.5, z+0.5, NukeTypes.LITTLE_BOY));
		}
