...
public class RenderBlockRBMKColumn implements BlockRenderType {
	...
	public void renderOnInventory(Block block, int meta, float brightness, RenderBlocks renderer) {
		...
		if (block == BlockInit.rbmkControl) {
			block.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 0.125F, 1.0F);

			tes.setNormal(0.0F, -1.0F, 0.0F);
			renderer.renderBottomFace(block, -0.5, 0.75, -0.5, block.getBlockIconFromSideAndMetadata(0, meta));
			tes.setNormal(0.0F, 1.0F, 0.0F);
			renderer.renderTopFace(block, -0.5, 0.75, -0.5, block.getBlockIconFromSideAndMetadata(1, meta));
			tes.setNormal(0.0F, 0.0F, -1.0F);
			renderer.renderEastFace(block, -0.5, 0.75, -0.5, block.getBlockIconFromSideAndMetadata(2, meta));
			tes.setNormal(0.0F, 0.0F, 1.0F);
			renderer.renderWestFace(block, -0.5, 0.75, -0.5, block.getBlockIconFromSideAndMetadata(3, meta));
			tes.setNormal(-1.0F, 0.0F, 0.0F);
			renderer.renderNorthFace(block, -0.5, 0.75, -0.5, block.getBlockIconFromSideAndMetadata(4, meta));
			tes.setNormal(1.0F, 0.0F, 0.0F);
			renderer.renderSouthFace(block, -0.5, 0.75, -0.5, block.getBlockIconFromSideAndMetadata(5, meta));

			block.setBlockBounds(0.25F, 0.0F, 0.25F, 0.75F, 1.0F, 0.75F);

			tes.setNormal(0.0F, 0.0F, -1.0F);
			renderer.renderEastFace(block, -0.5, -0.25, -0.5, block.getBlockIconFromSideAndMetadata(2, meta));
			tes.setNormal(0.0F, 0.0F, 1.0F);
			renderer.renderWestFace(block, -0.5, -0.25, -0.5, block.getBlockIconFromSideAndMetadata(3, meta));
			tes.setNormal(-1.0F, 0.0F, 0.0F);
			renderer.renderNorthFace(block, -0.5, -0.25, -0.5, block.getBlockIconFromSideAndMetadata(4, meta));
			tes.setNormal(1.0F, 0.0F, 0.0F);
			renderer.renderSouthFace(block, -0.5, -0.25, -0.5, block.getBlockIconFromSideAndMetadata(5, meta));
