...
public class RenderBlockBloomeryPipe implements BlockRenderType {
	public static final RenderBlockBloomeryPipe INSTANCE = new RenderBlockBloomeryPipe();
	...
	public boolean render(IBlockAccess world, Block block, int x, int y, int z, RenderBlocks renderer) {
		if (world.getBlockId(x, y+1, z) == block.blockID) {
			block.setBlockBounds(0.125F, 0.0F, 0.125F, 0.875F, 1.0F, 0.875F);
	...
	private void draw(Block block, Tessellator tes, RenderBlocks renderer) {
